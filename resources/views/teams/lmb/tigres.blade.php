@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/tigresqr.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
                    Tigres de <br>Quintana Roo
                    </h1>
            ...
            <div class="right-side">
                <p> 
                La piel del equipo que nació campeón está en MauCap. Apoya a tu equipo con los jerseys y gorras oficiales de juego de los Tigres de Quintana Roo de la LMB.    
            </p>
