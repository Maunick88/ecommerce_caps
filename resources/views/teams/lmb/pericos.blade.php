@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/pericos.png') }}" class="star" alt="">
                <div class="title">
                    <h1> Pericos de Puebla</h1>
                    <h2>Selecciona tu estilo</h2>
                </div>
            </div>
            <div class="right-side">
                <p> 
                Gorras de los Pericos de Puebla, playeras, sudaderas y más. Gorras planas de los Pericos de Puebla, curvas, buckets, gorritos, etc.
                </p>
