@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/diablos.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
            ...
            <div class="right-side">
                <p> 
                Gorras de los Diablos Rojos del Mexico para los auténticos fanáticos. Explora nuestras gorras curvas y planas de los Minnesota Diablos Rojos del Mexico y muestra con orgullo los colores de tu equipo.
                </p>
