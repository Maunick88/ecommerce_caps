@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/sultanes.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
                    Sultanes de <br> Monterrey
                    </h1>
            ...
            <div class="right-side">
                <p> 
                La piel del equipo que nació campeón está en MauCap. Apoya a tu equipo con los jerseys y gorras oficiales de juego de los Sultanes de Monterrey de la LMB.    
            </p>
