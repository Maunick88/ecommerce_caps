@include('header')  
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/yankees.png') }}" class="star" alt="">
                <div class="title">
            ...
            <div class="right-side">
                <p> 
                Gorras de los Yankees para los verdaderos aficionados. Elige entre nuestras gorras curvas y planas de los New York Yankees y muestra con estilo los legendarios colores de tu equipo.
                </p>
