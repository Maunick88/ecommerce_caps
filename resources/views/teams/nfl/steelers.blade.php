@include('header')  
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/steelers.png') }}" class="star" alt="">
                <div class="title">
                    <h1>                                    
                        Pittsburgh Steelers
                    </h1>
            ...
            <div class="right-side">
                <p> 
                Gorras de los Steelers para los verdaderos fanáticos. Elige entre nuestras gorras curvas y planas de los Pittsburgh Steelers y lleva con orgullo los colores de tu equipo histórico.
                </p>   
                <div class="line"></div>
            </div>
        </div>
