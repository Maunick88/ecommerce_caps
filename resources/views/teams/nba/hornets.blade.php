@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/hornets.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
                    Charlotte Hornets
                    </h1>
            ...
            <div class="right-side">
                <p> 
                Gorras de los Hornets para los seguidores más apasionados. Descubre nuestras gorras curvas y planas de los Charlotte Hornets y lleva con orgullo los colores de tu equipo legendario.
                </p>
