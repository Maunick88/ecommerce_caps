@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/bulls.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
                    Chicago Bulls
                    </h1>
            ...
            <div class="right-side">
                <p> 
                Gorras de los Bulls para los seguidores más apasionados. Descubre nuestras gorras curvas y planas de los Chicago Bulls y lleva con orgullo los colores de tu equipo legendario.
                </p>
