@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/redbull.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
                    Oracle Red <br>Bull Racing
                    </h1>
            ...
            <div class="right-side">
                <p> 
                Gorras de Oracle Red Bull Racing para los seguidores más apasionados. Descubre nuestras gorras curvas y planas de los Oracle Red Bull Racing y lleva con orgullo los colores de tu equipo legendario.
                </p>
