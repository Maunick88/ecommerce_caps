@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/mex.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
                    México M 
                    </h1>
            ...
            <div class="right-side">
                <p> 
                México de la colección México M que junta múltiples diseños y colores en el que destaca la icónica M de México bordada en los paneles frontales, la bandera de México al reverso y el flag de New Era bordado en el lado izquierdo. Luce con estilo y cómprala ya.
                </p>
