@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/chivas.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
            ...
            <div class="right-side">
                <p> 
                Gorras de las Chivas de Guadalajara para los seguidores más apasionados. Descubre nuestras gorras curvas y planas de los Chivas de Guadalajara y lleva con orgullo los colores de tu equipo legendario.
                </p>
