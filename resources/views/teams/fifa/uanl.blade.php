@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/tigres.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
                    Tigres de la UANL
                    </h1>
            ...
            <div class="right-side">
                <p> 
                Gorras de los Tigres de la UANL para los seguidores más apasionados. Descubre nuestras gorras curvas y planas de los Tigres de la UANL y lleva con orgullo los colores de tu equipo legendario.
                </p>
