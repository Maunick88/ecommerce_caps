@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/rayados.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
            ...
            <div class="right-side">
                <p> 
                Gorras de los Rayados de Monterrey para los seguidores más apasionados. Descubre nuestras gorras curvas y planas de los Rayados de Monterrey y lleva con orgullo los colores de tu equipo legendario.
                </p>
