@include('header')   
    ...
    <section>
        <div class="container">
            <div class="left-side">
                <img src="{{ asset('img/america.png') }}" class="star" alt="">
                <div class="title">
                    <h1> 
                    América
                    </h1>
            ...
            <div class="right-side">
                <p> 
                Gorras del equipo América para los seguidores más apasionados. Descubre nuestras gorras curvas y planas de los América y lleva con orgullo los colores de tu equipo legendario.
                </p>
